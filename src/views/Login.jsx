...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Mtumiaji akishafanikiwa kuingia, AuthContext itasoma state mpya na kubadili kurasa kiotomatiki
    } catch (err) {
      setError(err.message || 'Barua pepe au Nywila sio sahihi.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Ingia kwenye mfumo wa Letema Stationery & Internet Café
          </p>
        </div>
